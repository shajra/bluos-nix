...
The "main" branch provides the latest release of 3.20.6 of the controller. See
"old/*" branches for older versions.
...
As discussed in the [[file:doc/nix-usage-flakes.org][end user guide]] after [[file:doc/nix-installation.org][installing Nix]], we can run the BluOS
controller without even installing it:
