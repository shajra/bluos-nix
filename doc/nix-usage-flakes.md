...
```
    ...
    /nix/store/27yc9zlk39kq92l0vvghayrjd7s17rnn-bluos-controller
...
```
    ...
    /nix/store/27yc9zlk39kq92l0vvghayrjd7s17rnn-bluos-controller/bin/bluos-controller
...
```
    ...
    Store paths:        /nix/store/27yc9zlk39kq92l0vvghayrjd7s17rnn-bluos-controller
