...
```
    ...
    /nix/store/8liyabnplyrbfydbi9hkh6zpl3hldb53-bluos-controller/bin/bluos-controller
...
```
    ...
    Store paths:        /nix/store/8liyabnplyrbfydbi9hkh6zpl3hldb53-bluos-controller
