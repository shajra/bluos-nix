...
```
    ...
    * packages.x86_64-linux.bluos-controller
      BluOS Controller 4.14.1 (non-free)
...
```
    ...
    /nix/store/y468vr65x8zsvbyjllllgnjifs8z18kq-bluos-controller
...
```
    ...
    {
      "packages.x86_64-linux.bluos-controller": {
        "description": "BluOS Controller 4.14.1 (non-free)",
...
```
    ...
    /nix/store/y468vr65x8zsvbyjllllgnjifs8z18kq-bluos-controller/bin/bluos-controller
...
```
    ...
    Store paths:        /nix/store/y468vr65x8zsvbyjllllgnjifs8z18kq-bluos-controller
