...
```
    ...
    /nix/store/1fprfyif71lprl94lhrpbvwq8rfqy11h-bluos-controller
...
```
    ...
    /nix/store/1fprfyif71lprl94lhrpbvwq8rfqy11h-bluos-controller/bin/bluos-controller
...
```
    ...
    Store paths:        /nix/store/1fprfyif71lprl94lhrpbvwq8rfqy11h-bluos-controller
