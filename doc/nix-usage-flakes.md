...
```
    ...
    * packages.x86_64-linux.bluos-controller
      BluOS Controller 4.12.1 (non-free)
...
```
    ...
    {
      "packages.x86_64-linux.bluos-controller": {
        "description": "BluOS Controller 4.12.1 (non-free)",
...
```
    ...
    /nix/store/cck94di23fbq03bhjc0i6grhkgjn1cfl-bluos-controller/bin/bluos-controller
...
```
    ...
    Store paths:        /nix/store/cck94di23fbq03bhjc0i6grhkgjn1cfl-bluos-controller
