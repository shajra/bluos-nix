...
```
    ...
    * packages.x86_64-linux.bluos-controller
      BluOS Controller 4.8.0 (non-free)
...
```
    ...
    /nix/store/mf87a0ibfk47vnj21hplnc3ngwsa0740-bluos-controller
...
```
    ...
    {
      "packages.x86_64-linux.bluos-controller": {
        "description": "BluOS Controller 4.8.0 (non-free)",
...
```
    ...
    /nix/store/mf87a0ibfk47vnj21hplnc3ngwsa0740-bluos-controller/bin/bluos-controller
...
```
    ...
    Store paths:        /nix/store/mf87a0ibfk47vnj21hplnc3ngwsa0740-bluos-controller
