...
```
    ...
    /nix/store/xxkjlnjk6wla1bkkn1kx0bnlapb7yc3m-bluos-controller/bin/bluos-controller
...
```
    ...
    Store paths:        /nix/store/xxkjlnjk6wla1bkkn1kx0bnlapb7yc3m-bluos-controller
