...
```
    ...
    /nix/store/3n5xgdsfn819z16gn6p92d3j4jhi8skv-bluos-controller/bin/bluos-controller
...
```
    ...
    Store paths:        /nix/store/3n5xgdsfn819z16gn6p92d3j4jhi8skv-bluos-controller
