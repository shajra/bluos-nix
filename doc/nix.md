...
[This project's continuous integration (using GitHub Actions)](https://github.com/shajra/bluos-nix/actions) caches built packages at [Cachix](https://cachix.org/), a service for caching pre-built Nix packages. If you don't want to wait for a full local build when first using this project, setting up Nix to pull from Cachix is recommended.
...
```
    ...
    /nix/store/19mqpk3npnvplhs983gpysb2sb6zgk5w-bluos-controller
